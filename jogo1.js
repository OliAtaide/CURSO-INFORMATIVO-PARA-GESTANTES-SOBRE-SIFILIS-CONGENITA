questoes = [
    ...
    {
        titulo: 'Sífilis tem cura?',
        opcoes: [
            'Sim',
            'Não'
        ],
        resposta: 1,
        textoAcertou: 'Isso mesmo! A sífilis tem cura.',
    ...
    {
        titulo: 'Em algum estágio da sífilis a pessoa infectada não apresenta sintoma, ou seja, aparenta não estar doente?',
        opcoes: [
            'Sim. Durante a sífilis latente, que é caracterizada pela ausência total de sintomas clínicos.',
            'Não. A pessoa infectada sempre irá apresentar sintomas.'
        ],
        resposta: 1,
        textoAcertou: 'Isso! Durante a fase de latência, a pessoa infectada não apresenta sintomas clínicos da doença.',
        textoErrou: 'Ops! Tem certeza?'
    },
    {
        titulo: 'O Brasil vive uma epidemia de sífilis desde 2016?',
        opcoes: [
            'Verdadeiro.',
            'Falso.'
        ],
        resposta: 1,
        textoAcertou: 'Você acertou! Os números de novos casos no Brasil estão aumentando muito.',
        textoErrou: 'Ops! Tem certeza? Vamos reavaliar.'
    },
    {
